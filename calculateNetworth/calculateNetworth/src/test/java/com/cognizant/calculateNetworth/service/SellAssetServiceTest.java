...
class SellAssetServiceTest {
	...
	/*
	 * @Test void testDeleteStockAssetWithUnits() { Map<String, Integer> idList=new
	 * HashMap<>(); idList.put("ABC", 5);
	 * when(repository.findByPortfolioidAndAssetidAndType(0,"ABC","Share")).
	 * thenReturn(new Asset()); sellAssetService.deleteStockAssetWithUnits(0,
	 * idList); }
	 * 
	 */
	@Test
